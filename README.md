...
```
combine -M FitDiagnostics card_systematics.root --saveNormalizations --plot --saveShapes --saveWithUncertainties --saveWorkspace --setParameters mask_TwoMuZH=1 -n MaskedData
